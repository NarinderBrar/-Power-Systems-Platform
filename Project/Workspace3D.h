...
#ifndef WORKSPACE3D_H
#define WORKSPACE3D_H
 ...
 * @file Workspace.h
 */
class Workspace3D : public WorkspaceBase
{
public:
    ...
    Workspace3D();
    Workspace3D( wxWindow* parent, wxString name = wxEmptyString, wxStatusBar* statusBar = nullptr, wxGLContext* sharedGLContext = nullptr );
    virtual ~Workspace3D();
    ...
    int GetElementNumber( Element3DID elementID )
    {
        return m_elementNumber[elementID];
    }
    void IncrementElementNumber( Element3DID elementID )
    {
        m_elementNumber[elementID]++;
    }
...
protected:
    ...
    int m_elementNumber[NUM_ELEMENTS_3D];
